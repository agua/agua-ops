...
has 'savefields'	=> ( isa => 'ArrayRef|Undef', is => 'rw', default => sub { ['package', 'version', 'type', 'branch', 'treeish', 'history', 'installtype', 'opsfile', 'installfile', 'licensefile', 'readmefile', 'description', 'website', 'authors', 'publication', 'organisations', 'ISA', 'acknowledgements', 'citations']	});
